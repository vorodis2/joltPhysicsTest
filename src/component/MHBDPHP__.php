<?php
    ...
    function getDirs1($dir,$sah, $arrNot,$bSize){
        //cleanerDir($dir."/");
        ...
        if ($objs = glob($dir."/*")) {
            ...
            foreach($objs as $obj) {
                ...
                if(is_dir($obj."/")){
                    ...
                    if($bbb==1){
                        $str=$str.'{"'.$s.'":'.getDirs1($obj, $sah+1,$arrNot,$bSize).'}';
                    }else{
                    ...
                    if($bSize==0){
                       ...
                       // $str=$str.'"'.$s.'",'.filesize($obj);  
                        $str=$str.'"'.$s.'",'.filesize($obj).','.filectime($obj); 
    ...
    if($tip == "getFiles1"){  
        ...
        $ff = getDirs1($_REQUEST['dir'],0,$_REQUEST['arrNot'],0);        
        echo $ff;//$ff; 
        return;
    ...
    if($tip == "getFiles2"){
        $ff = getDirs1($_REQUEST['dir'],0,$_REQUEST['arrNot'],1);        
        echo $ff;//$ff; 
        return;
