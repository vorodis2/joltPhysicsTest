...
export class DDCont{
    constructor(par,fun) {
        ...
        this.dCont1.x=0;
        this.dCont1.y=this.param.otstup+dcmParam.fontSize//Litte;
        ...
        var chek=new DCheckBox(this.dCont,otstup,otstup," ",function(){
        ...
        var lInfo=new DLabel(this.dCont,otstup+24,otstup,"null");
